...
Some of these files are not as polished as my newer SQL and Python work, but I think they are still useful to show. They show the Excel and business modeling side of my background, especially forecasting, Solver, and optimization. That matters for analyst roles where the work is often a mix of dashboards, spreadsheets, and explaining tradeoffs to non-technical people.
